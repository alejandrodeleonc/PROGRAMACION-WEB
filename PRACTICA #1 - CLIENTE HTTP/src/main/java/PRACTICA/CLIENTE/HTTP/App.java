...
public class App {
    ...
    public static void main(String[] args) {
        String url;
        print("PRACTICA #1 - CLIENTE HTTP INTERNET AVANZADO (3/2019-2020)");
        print("Presentado por: Alejandro De Leon C. 20160338(10128009) ITT\n");
    ...
    private static int imginparagraph(Elements par){
        /*Esta funcion cuenta las imagenes que estan 
        en los parrafos, se le pasa como paremetro directamente los elementos parrafos <p>
        y esta retorna la cantidad de imagines que hay dentro de los parrafos*/
        int aux = 0;
    ...
    public static int[] clasifyForms(Elements forms){
        /*Esta funcion es la encargada de clasificar las formas 
        en formas de get o de post, esta se le pasa como parametro directamente las formas
        del documento, y la funcion misma retorna un arreglo que en la posicion cero tiene la 
        cantidad de formas get y en la posicion uno tiene la cantida de post */
        int getForms = 0;
        int postForms = 0;
        int f[] = new int [2];
    ...
    public static ArrayList<String> inputs(Element form){
        /*Esta funcion retorna los inputs que hay una forma, los devuelve en un array list */
        ArrayList<String> in = new ArrayList<String>();
    ...
    public static String post(int verify, Elements forms) throws IOException {
        ...
        que es a cantidad de formas post que hay (Que se obtuvo en la funcion clasifyForms) 
        ...
        if(verify != 0){
            for(Element f : forms){
                ...
                Connection.Response res =  ((FormElement)f).submit().data("Internet avanzado", "Practica #1").header("Matricula","20160338(10128009)").execute();             
                respuesta += "\t"+res.body() + "\n";
